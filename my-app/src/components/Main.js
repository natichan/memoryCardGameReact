...
class Main extends Component {
  ...
  selectCard(card){
    ...
    // uso la carta  que está llegando para actualizar el array de las cartas que están siendo seleccionadas
    ...
    compairMatch(selectedMatch) {
      ...
      // se hace un delay en la ejecución, para que se pueda ver la segunda carta que escogió, después de un segundo la revisamos, si no es la volteamos y si es la dejamos volteadas
      setTimeout(() => {
        ...
        if (firstCard.image === secondCard.image) {
          deck = deck.map((card) => {
            ...
            // expande todas sus propiedades y reemplaza la propiedad de carta adivinada como verdadera
          });
        }
      ...
      return (
        <div>
          ...
          <Board 
            ...
            deck = {this.state.deck} //hacemos referencia al estado inicial que contiene la propiedad deck
            selectedMatch = {this.state.selectedMatch} // para decirle que está seleccionada
            // una referencia al método seleccionar carta, va a ser ejecutado cuando se haga click en la carta
