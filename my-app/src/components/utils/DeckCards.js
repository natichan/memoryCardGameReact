...
export default () => {
  ...
  while (cards.length < numberOfCards) { // cuando tenga el número de cartas deja de mandar
    ...
    // multiplicamos por el numero de cartas de que tenemos
  ...
  // como ambas están en posiciones consecutivas
  // usaremos el modulo lodash suffle para mezclar las cartas
};
